...
public class ImageRestController {
	...
	public Image uploadMultiImages(@RequestParam("image")MultipartFile file, @PathVariable("idEcriv") Long idEcriv) throws IOException {
		return imageService.uplaodImageEcriv(file,idEcriv);
	}
	
	@RequestMapping(value = "/getImagesEcriv/{idEcriv}" , method = RequestMethod.GET)
	public List<Image> getImagesEcriv (@PathVariable("idEcriv") Long idEcriv) throws IOException {
